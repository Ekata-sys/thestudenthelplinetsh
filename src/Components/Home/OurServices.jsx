   ...
   <div className="text-center mb-4">
    ...
    <div className="course-details__content">
                  ...
                  <p>Assignments have become an intrinsic part of assessing a student’s academic knowledge. Losing marks in assignments can negatively affect your academic records, which sometimes would cost you an arm and a leg, keeping your career life at stake. However, it can sometimes be stressful as students these days are endowed with an array of works to meet the curricular demands and in some cases, the students might lack the knack of creating a work from scratch. If you are one among them, you have reached the right place! Leave your burden on us and relax! Our team of writers is specialises in writing quality assignments, and no student who took our<Link to="https://thestudenthelpline.io/au/">assignment help</Link> was disappointed indeed, had fallen short of words to thank us.</p>					   <div className="text-end text-center py-2">						<Link  className="btn-prm" to="/order-now">Order Now</Link>			</div>
					 ...
					 <p>In this era of online classes and exams, there is a skyrocketing demand for exam help services. Our subject experts are on their toes to take your role, take the test and help you pass the exam meritoriously. How much better that can be! We are sure that you will agree with us when we say certificates matter!</p>                            <div className="text-end text-center py-2">								<Link className="btn-prm" to="/order-now">Order Now</Link>					</div>
                               </div>
                              </div>
